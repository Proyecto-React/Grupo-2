...
function getTableDataCellWidth(width, field, columns, actions) {
    ...
    return width
        ...
        : field === 'actionsCol'
            ...
            : `calc((100% - ${columns.some((el) => el.field === 'actionsCol') ? `${finalActionsColumnsWidth}px` : '0'
...
const DropdownComponent = ({
    ...
    return (
        ...
        >
            ...
            <div
                className={`dropdown-wrapper ${dropdownClassName ? dropdownClassName : ''} ${styles.left < menuWidth ? 'is-right' : ''
                ...
                <Portal wrapperElement="span" wrapperElementId="dropdown">
                    {isOpen && (
                        <div className={`${styles.left < menuWidth ? 'is-right' : ''}`}>
                            <div
                                className={`dropdown-body ${bodyClassName} ${isDropdownOnTop ? 'dropdown-on-top' : ''
                                    } ${isOpen && 'open'}`}
                                ref={dropdownMenuRef}
                                style={{
                                    ...styles,
    ...
    return (
        ...
        >
            {columns.map((col, colIndex) => (
                ...
                >
                    <div
                        className={`${colIndex === 0 && row.draggable && !isTouchDevice ? 'd-flex align-items-center' : ''
                            }`}
                    >
    ...
    const teamsRecords = teamDetails,
        teamsColumns = [
            ...
            },
            {
                ...
                render: (rowData) => (
                    <p
                        className={`status ${rowData.subscription.status.toLowerCase() === 'active'
                                ? 'success'
